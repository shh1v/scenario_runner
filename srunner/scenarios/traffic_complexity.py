...
class TrafficComplexity(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
                 timeout=60):
        """
        Initialize all parameters required for traffic complexity scenario
        """
    ...
    def _create_behavior(self):
        """
        Setup the behavior for traffic complexity scenario
        """

    def _create_test_criteria(self):
        """
        Setup the evaluation criteria for traffic complexity scenario
        """