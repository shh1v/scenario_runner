...
class TrafficLightTrap(BasicScenario):
    ...
    def _initialize_actors(self, config):
        ...
        traffic_light_locns = [
            ...
            carla.libcarla.Location(*[85.73, 45.78, 0.0]),
            carla.libcarla.Location(*[85.72, 119.75, 0.0]),
    ...
    def _create_behavior(self):
        ...
        traffic_light_superseq = py_trees.composites.Parallel()
        ...
        for i in range(self.trap_length):
            ...
            traffic_light_superseq.add_child(traffic_light_seq)
            traffic_light_seq = py_trees.composites.Sequence()
        ...
        sequence = py_trees.composites.Parallel(
            ...
            children=[traffic_light_superseq, jaywalk_sequence],
        )
